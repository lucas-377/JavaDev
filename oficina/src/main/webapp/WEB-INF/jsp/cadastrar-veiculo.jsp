...
<body>
    ...
    <div class="modal">
        ...
        <div class="modal-menu ativo">
            ...
            <h2 class="titulo">Cadastrar tipo de veículo</h2>

            <form method="POST" class="input-group">
                <label for="pecas" class="input-icone"><i class="far fa-edit"></i></label>
                <input type="text" class="input" id="pecas" name="dados" placeholder="Digite aqui o tipo de veículo" required>

                <span class="cadastro valido"><i class="fas fa-check"></i></span>
                <span class="cadastro erro"><i class="fas fa-times"></i></span>

                <div class="container-radios">
                	<h4 class="radios-titulo">PEÇAS</h4>
                	
                    <div class="radio">
                        <input type="radio" name="pecas" id="rodas" value="rodas">
                        <label for="rodas">Rodas</label>
                    </div>
                    
                    <div class="radio">
                        <input type="radio" name="pecas" id="motor" value="motor">
                        <label for="motor">Motor</label>
                    </div>
                    
                    <div class="radio">
                        <input type="radio" name="pecas" id="para-choque" value="para-choque">
                        <label for="para-choque">Para-choque</label>
                    </div>
                </div>
